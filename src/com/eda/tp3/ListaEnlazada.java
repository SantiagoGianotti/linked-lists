...
public class ListaEnlazada
{
    ...
    public int sumatoriaPares()
    {
        return this.sumatoriaPares(0, this.primero);
    }

    private int sumatoriaPares(int sumaParcial, Nodo nodoActual)
    {
        int calculo;
        ...
        calculo = nodoActual.getNumero() % 2 == 0? sumaParcial+=nodoActual.getNumero() : sumaParcial;

        return sumatoriaPares(calculo, nodoActual.getSiguiente());
